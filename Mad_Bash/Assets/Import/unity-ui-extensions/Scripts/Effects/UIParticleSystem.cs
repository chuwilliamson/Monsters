    ...
    public class UIParticleSystem : MaskableGraphic
    {
        ...
        protected bool Initialize()
        {
            ...
            if (_particleSystem == null)
            {
                ...
                _particleSystemMainModule.scalingMode = ParticleSystemScalingMode.Local;
                _particles = null;
            ...
            if (_particles == null)
            {
                _particles = new ParticleSystem.Particle[_particleSystemMainModule.maxParticles];
            }
        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (int i = 0; i < count; ++i)
            {
                ...
                Vector2 position = (_particleSystemMainModule.simulationSpace == ParticleSystemSimulationSpace.Local ? particle.position : _transform.InverseTransformPoint(particle.position));
                ...
                // apply scale
                if (_particleSystemMainModule.scalingMode == ParticleSystemScalingMode.Shape)
                {
